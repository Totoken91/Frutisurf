...
| **ORBITE** | 0 % | **le vol.** Une planétoïde brisée, sans atmosphère. Le ciel n'est pas assombri, il est **vidé** : voile d'horizon, diffusion, remplissage sous la ligne de sol — tous les termes qui supposent de l'air sont éteints, et le sol touche le noir pur. Ce qui reste, c'est l'étoile, un champ d'étoiles à magnitudes, et des crêtes aussi contrastées à deux kilomètres qu'à deux mètres. Le sol est une **obsidienne fracturée** : un réseau de failles calé sur les arêtes d'un diagramme de Voronoï, d'où sort la seule couleur du monde — un cyan **émissif**, qui brûle aussi fort du côté à l'ombre. Et des **blocs en apesanteur** dérivent entre dix et soixante-dix mètres, facettes dures, face inférieure éclairée par les failles qu'ils survolent. C'est le monde le plus aérien du jeu : 106 envols par partie, contre 72 sur la plaine. |
