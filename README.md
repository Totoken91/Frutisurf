...
| **NÉBULA** | 18 % | **le vol.** Une lune sans atmosphère : ciel noir en plein jour, champ d'étoiles à magnitudes, Voie lactée avec ses voies sombres, une géante gazeuse à anneaux et un halo de cristaux. Le sol est une vraie **régolithe** — sombre (albédo 0,12, et c'est ce contraste qui fait l'espace), criblée de cratères sur deux échelles dont la **pente** sculpte les flancs, et semée de billes de verre d'impact qui accrochent l'étoile. L'arc-en-ciel n'y est pas peint : c'est une **irisation de couche mince**, donc sa teinte vient de l'angle et jamais de la position — avance de deux pas et le halo se déplace sur le sol. Gravité douce : la portance à 1,45 y donne les vols les plus longs du jeu (104 envols par partie contre 72 sur la plaine), et le prix est immédiat — un disque qui plane **ne mord pas**, donc on ne rattrape rien une fois en l'air. |
